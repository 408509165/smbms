...
<%@include file="common/head.jsp"%>
    <div class="right">
        ...
        <form id="userForm" name="userForm" method="post" action="${pageContext.request.contextPath }/user/doupdateuser.html">
			<input type="hidden" name="id" value="${user.id }"/>
			 ...
			 <div>
                    ...
                    <input type="text" Class="Wdate" id="birthday" name="birthday1" value="<fmt:formatDate value="${user.birthday }" pattern="yyyy-MM-dd"/>"
