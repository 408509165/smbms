...
<div class="right">
        ...
        <div class="providerAdd">
          <form id="billForm" name="billForm" method="post" action="${pageContext.request.contextPath }/bill/submitbill.html">
                ...
                <div>
                    ...
                    <input type="hidden" value="${bill.providerId }" id="pid" name="pid" />
...
<script type="text/javascript" src="${pageContext.request.contextPath }/statics/js/comm.js">
<!--
