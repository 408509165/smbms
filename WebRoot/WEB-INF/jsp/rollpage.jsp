...
<script type="text/javascript">
	...
	//alert(form.id);
		var id=form.id;
		if(id=="billlist"){
			form.action = "/ch102/bill/billlist.html?pageIndex="+pageIndex+"";
		}else if(id=="userlist"){
			form.action = "/ch102/user/userlist.html?pageIndex="+pageIndex+"";
		}else if(id=="providerlist"){
			form.action = "/ch102/provider/providerlist.html?pageIndex="+pageIndex+"";
		}
		form.submit();
	}
...
<body>
	     ...
	     <input type="text" name="inputPage" id="inputPage" value="${param.currentPageNo }" style="text-indent:1.2em" class="page-key" />页
